...
const App: React.FC = () => {
  return (
    <div 
      className="w-full h-screen bg-gray-50 flex flex-col items-center justify-center touch-none select-none"
    ...
    >
      ...
      <div className="w-full h-full">
        {/* 
          ...
          Added touch-none to Canvas to ensure touch events are not captured by browser scrolling.
        */}
        <Canvas 
          shadows 
